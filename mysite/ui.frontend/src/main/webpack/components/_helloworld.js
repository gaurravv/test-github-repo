...
// This script logs the value of the component's text property model message to
// the console
...
// Best practice:
// For a good separation of concerns, don't rely on the DOM structure or CSS
// selectors, but use dedicated data attributes to identify all elements that
// the script needs to interact with.
var selectors = {
...
// Best practice:
// Use a method like this mutation obeserver to also properly initialize the
// component when an author drops it onto the page or modified it with the
// dialog.
      ...
      if (nodesArray.length > 0) {
        nodesArray.forEach(function(addedNode) {
          if (addedNode.querySelectorAll) {
            ...
            elementsArray.forEach(function(
                element) { new HelloWorld({element : element}); });
          }
        });
      }
    });
